            ...
            $output = $this->tableTr();
                ...
                $output.= $this->tableTd();
                    ...
                    if(!empty($attr['upload']) && is_array($attr['upload'])){    //Image Upload True
                        ...
                        $output.= '
                        <div class="mondira-media-upload-button">
                            <a class="upload_image_button_latest button theme-upload-button" id="'.$attr['id'].'_thickbox" href="media-upload.php?post_id=0&target='.$attr['id'].'&mondira_image_upload=1&type=file&TB_iframe=1&width=640&height=644">'.$attr['upload_zip']['title'].'</a>';
                        $output.= '</div>';
